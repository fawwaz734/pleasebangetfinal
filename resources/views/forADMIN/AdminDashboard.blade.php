...
@if($products->isEmpty())
    <div class="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <a href="{{ route('forADMIN.products.create') }}" class="mt-4 inline-block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Tambahkan Produk Pertama Anda?</a>
    </div>
@else
